---
title: 전환 모듈 워크스루
description: '[!DNL Adobe Workfront Fusion]에서 보다 복잡하거나 동적인 데이터 변환을 수행해야 하는 경우 Switch 모듈을 사용하는 방법에 대해 알아봅니다.'
activity: use
...
>[!VIDEO](https://video.tv.adobe.com/v/3417936/?captions=kor&quality=12&learn=on&enablevpops=1)
