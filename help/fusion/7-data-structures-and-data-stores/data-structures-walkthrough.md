---
title: 데이터 구조 워크스루
description: 한 파일에서 시간 로그 정보를 가져와서 변형하고 [!DNL Adobe Workfront Fusion]에서 변환된 데이터를 사용하여 새 파일을 만드는 방법에 대해 알아봅니다.
activity: use
...
>[!VIDEO](https://video.tv.adobe.com/v/3417960/?captions=kor&quality=12&learn=on&enablevpops=1)
