---
title: 오류 처리 지시문 이해
description: '[!DNL Adobe Workfront Fusion]에서 실행을 계속할 수 있도록 하는 오류 처리기 지시문과 실행을 중지하는 지시문에 대해 알아봅니다.'
activity: use
...
>[!VIDEO](https://video.tv.adobe.com/v/3418139/?captions=kor&quality=12&learn=on&enablevpops=1)
