---
title: 불완전한 실행 연습
description: 에서 오류를 평가하고 수정한 후 불완전한 실행을 저장한 다음 번들을 다시 실행하는 것의 가치를 알아봅니다. [!DNL Adobe Workfront Fusion].
activity: use
...
불완전한 실행을 저장하는 유용한 습관을 알아보고 오류를 평가하고 수정한 후 번들을 다시 실행할 때 제공되는 값을 이해합니다.
