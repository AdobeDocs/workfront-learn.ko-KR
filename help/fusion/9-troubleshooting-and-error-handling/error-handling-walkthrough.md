---
title: 오류 처리 워크스루
description: '[!DNL Adobe Workfront Fusion]에서 지시문을 사용하여 기본 오류 처리가 발생하는 방식과 특정 모듈 오류 처리를 추가하는 방법을 알아봅니다.'
activity: use
...
>[!VIDEO](https://video.tv.adobe.com/v/3418145/?captions=kor&quality=12&learn=on&enablevpops=1)
