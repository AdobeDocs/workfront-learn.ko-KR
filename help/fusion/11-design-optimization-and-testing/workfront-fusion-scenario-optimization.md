...
description: '[!DNL Adobe Workfront Fusion]에서 더 적은 수의 작업을 수행하고, 더 적은 수의 API 호출을 보내고, 더 적은 수의 모듈을 사용하는 방법을 알아봅니다.'
activity: use
...
>[!VIDEO](https://video.tv.adobe.com/v/3418207/?captions=kor&quality=12&learn=on&enablevpops=1)
