...
한 이메일에는 Workfront Fusion 시스템 관리자가 프로필을 만들고 조직에 초대할 때 추가한 메모가 있습니다. 이메일 하단에는 [!UICONTROL 역할 수락] 버튼이 있습니다. **아직 이 버튼을 클릭하지 마십시오!**
...
로그인하고 나면 다른 전자 메일로 돌아가서 [!UICONTROL 역할 수락] 단추를 클릭합니다.
