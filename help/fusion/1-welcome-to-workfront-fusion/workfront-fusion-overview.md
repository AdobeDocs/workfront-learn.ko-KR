...
[이 양식](https://forms.office.com/r/f1J8HRGrNY)을 작성하여 테스트 드라이브를 요청합니다. 양식에 액세스할 수 없다면 이름, 이메일 주소, 회사 이름을 wfttstdr@adobe.com으로 보내 주십시오.
...
대부분의 워크스루 연습을 완료하기 위한 단계별 지침이 있습니다. 이 지침은 워크스루 튜토리얼이 완료되는 직후에 표시되는 왼쪽 탐색 막대에서 찾을 수 있습니다.
