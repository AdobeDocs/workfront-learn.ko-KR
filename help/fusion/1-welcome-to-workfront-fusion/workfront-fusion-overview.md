...
[이 양식](https://forms.office.com/r/f1J8HRGrNY)을 입력하여 테스트 드라이브를 요청하세요. 양식에 액세스할 수 없다면 이름, 이메일 주소, 회사 이름을 wfttstdr@adobe.com으로 보내 주십시오.
...
대부분의 연습 연습을 완료하는 데 대한 단계별 지침이 있습니다. 이 연습 자습서 바로 뒤에 있는 왼쪽 탐색 모음에서 찾을 수 있습니다.

### 선택적 연습 문제

연습 연습 연습 및 과제는 연습 연습 연습 연습 다음에 제공됩니다.

연습 문제를 해결하는 방법에는 여러 가지가 있습니다. 회사에서 시나리오를 빌드할 때 해야 할 일이기 때문에 의도는 따라야 할 단계나 “정답” 없이 시나리오 목표를 달성하도록 도전하는 것입니다.
