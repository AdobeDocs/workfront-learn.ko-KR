---
title: 고급 집계 워크스루
description: 웹 서비스를 호출하여 [!DNL Adobe Workfront Fusion]에서 여러 국가에 대한 세부 정보를 반환하고 하위 지역으로 그룹화된 모집단을 식별하는 방법을 알아봅니다.
activity: use
...
>[!VIDEO](https://video.tv.adobe.com/v/3417306/?captions=kor&quality=12&learn=on&enablevpops=1)
...
마케팅 포트폴리오의 프로젝트에서 작업에 로그온한 모든 시간을 합산하는 새 시나리오를 만듭니다. 그런 다음 &quot;내 {Project Name} 프로젝트 팀이 계획된 총 {planned hours}시간 중 {summed hours}시간을 기록하여 플랜의 {percentage}을(를) 달성했습니다.&quot;라는 전자 메일을 보냅니다.
