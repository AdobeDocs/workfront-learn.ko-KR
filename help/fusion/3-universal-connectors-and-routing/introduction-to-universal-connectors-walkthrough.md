...
description: HTTP 커넥터를 통해 Poke API를 호출하여 [!DNL Adobe Workfront Fusion]에서 Pokemon 문자에 대한 정보를 수집하고 게시하는 방법을 알아봅니다.
activity: use
...
>[!VIDEO](https://video.tv.adobe.com/v/3416562/?captions=kor&quality=12&learn=on&enablevpops=1)
