---
title: 라우팅 패턴 워크스루
description: 변수 설정 모듈을 사용하여 여러 경로를 통해 숫자를 전송하여 [!DNL Adobe Workfront Fusion]에서 필터 및 폴백이 작동하는 방식을 확인하는 방법을 알아봅니다.
activity: use
...
>[!VIDEO](https://video.tv.adobe.com/v/3417264/?captions=kor&quality=12&learn=on&enablevpops=1)
