...
+ 관리 및 설정 {#administration-and-setup}
   ...
   + 레이아웃 템플릿 {#layout-templates}
      ...
      + [레이아웃 템플릿으로 용어 맞춤화](administration-and-setup/layout-templates/customize-workfront-terminology.md)
      + [사용자 지정 [!UICONTROL 메인 메뉴] 레이아웃 템플릿 사용](administration-and-setup/layout-templates/customize-the-main-menu-with-layout-templates.md)
      + [레이아웃 템플릿을 통해 고정 항목 추가 및 관리](administration-and-setup/layout-templates/add-and-manage-pins-in-layout-template.md)
      + [레이아웃 템플릿으로 홈 맞춤화](administration-and-setup/layout-templates/customize-workfront-home-with-layout-templates.md)
      + [레이아웃 템플릿에 대한 액세스 권한 할당 및 관리](administration-and-setup/layout-templates/assign-and-manage-access-to-layout-templates.md)
   ...
   + 이메일 및 인앱 알림 {#email-and-in-app-notifications}
      ...
      + [보내기 [!UICONTROL 알림 센터] 메시지](administration-and-setup/email-and-in-app-notifications/admin-use-the-announcement-center.md)
   ...
   + 사용자 만들기 및 관리 {#create-and-manage-users}
      ...
      + [일괄 사용자 추가](administration-and-setup/create-and-manage-users/add-users-in-bulk.md)
...
+ 사용자 정의 데이터 {#custom-data}
   ...
   + 계산된 표현식 {#calculated-expressions}
      ...
      + [날짜 및 시간과 수학 표현식 이해](custom-data/calculated-expressions/date-and-time-and-mathematical-expressions.md)
      ...
      + [SUB, SUM, DIV 또는 PROD 데이터 표현식 작성](custom-data/calculated-expressions/create-a-sub-sum-div-or-prod-data-expression.md)
...
+ 작업 관리 {#manage-work}
   + 프로젝트 {#projects}
      + [기본 프로젝트 생성 이해](manage-work/projects/understand-basic-project-creation.md)
      + [프로젝트를 만드는 4가지 방법 알아보기](manage-work/projects/understand-other-ways-to-create-projects.md)
      ...
      + [프로젝트 실행](manage-work/projects/take-a-project-live.md)
...
+ 보고 {#reporting}
   ...
   + 중간 보고 {#intermediate-reporting}
      ...
      + [필터에서 OR 문 만들기](reporting/intermediate-reporting/or-statements-in-filters.md)
   ...
   + 고급 Analytics {#enhanced-analytics}
      ...
      + [작업 및 인물 차트 이해](reporting/enhanced-analytics/5-work-and-people-charts.md)
      ...
      + [작업 이해: 마우스를 가리킨 후 끌어서 클릭](reporting/enhanced-analytics/9-actions-hover-click-and-drag-and-click-in.md)
      ...
      + [일정 및 추가 차트를 사용하여 자세히 살펴보기](reporting/enhanced-analytics/12-digging-deeper-using-timeframes-and-additional-charts.md)
      ...
      + [진행 중인 작업 검토](reporting/enhanced-analytics/16-navigating-to-and-reviewing-the-tasks-in-flight.md)
      + [업데이트하여 조치 취하기](reporting/enhanced-analytics/17-taking-action-by-making-updates.md)
      + [팀별 활동 이해 차트](reporting/enhanced-analytics/18-activity-by-team-chart.md)
      + [자원 수용작업량 차트 이해](reporting/enhanced-analytics/19-resource-capacity-chart.md)
      + [팀 수용작업량 이해](reporting/enhanced-analytics/20-team-capacity-overview.md)
...
+ 리소스 관리 {#manage-resources}
   ...
   + 시나리오 플래너 {#scenario-planner}
      ...
      + [시나리오 플래너에서 계획 액세스](manage-resources/scenario-planner/access-a-plan-in-scenario-planner.md)
      + [시나리오 플래너에서 계획 생성](manage-resources/scenario-planner/create-plans-in-the-scenario-planner.md)
      + [플랜을 사용하여 이니셔티브 만들기](manage-resources/scenario-planner/creating-initiatives-within-a-plan.md)
...
+ Workfront 목표 {#workfront-goals}
   + 조직에 대한 비전 수립 {#establish-a-vision-and-strategy}
      ...
      + [Workfront 목표가 작업 주기에 어떻게 적합한지 이해](workfront-goals/establish-a-vision-for-your-org/where-does-workfront-goals-fit-in-with-my-work-cycle.md)
...
+ 통합 {#integrations}
   ...
   + Slack {#slack}
      ...
      + [다음을 통해 할 일 목록 액세스 [!UICONTROL Slack]](integrations/slack/access-your-to-do-list-through-slack.md)
...
+ Fusion {#fusion}
   ...
   + 기본 사항 이해 {#understand-the-basics}
      ...
      + [패널 중요 정보 매핑](fusion/2-understand-the-basics/mapping-panel-important-notes.md)
      + [기본 매핑 연습 기능 이상](fusion/2-understand-the-basics/beyond-basic-mapping-walkthrough.md)
   ...
   + 문제 해결 및 오류 처리 {#troubleshooting-and-error-handling}
      ...
      + [오류 처리 지침 이해](fusion/9-troubleshooting-and-error-handling/understand-error-handling-directives.md)
...
+ Workfront Proof {#workfront-proof}
   ...
   + 관리 및 설정 {#administration-and-setup-for-proof}
      ...
      + [증명에 대한 보고서](workfront-proof/administration-and-setup/report-on-proofs.md)
      + [기본 위험 증명 설정 설정](workfront-proof/administration-and-setup/set-default-at-risk-proof-settings.md)
      + [글로벌 증명 설정](workfront-proof/administration-and-setup/setup-global-proof-settings.md)
   ...
   + 증명 업로드 {#upload-proofs}
      ...
      + [웹 사이트의 증명 업로드](workfront-proof/upload-proofs/upload-a-proof-of-a-website.md)
   ...
   + 작업 검토 및 승인 {#review-and-approve-work-for-proof}
      ...
      + [증명이 포함된 비디오 검토](workfront-proof/review-and-approve-work/review-a-video-with-proof.md)
...
+ Workfront DAM {#workfront-dam-program}
   ...
   + 메타데이터 및 키워드 {#metadata-and-keywords}
      ...
      + [메타데이터 및 키워드를 사용하여 에셋 검색](workfront-dam/metadata-and-keywords/search-for-assets.md)
   ...
   + Workfront DAM 사용자: 기여자 {#workfront-dam-contributor}
      ...
      + [기여자로 에셋 찾기 이해](workfront-dam/workfront-dam-user-contributor/contributor-find-assets.md)
      + [Lightbox를 기여자로 이해](workfront-dam/workfront-dam-user-contributor/contributor-lightboxes.md)
      + [참여자로서 메타데이터 및 키워드 모범 사례 이해](workfront-dam/workfront-dam-user-contributor/metadata-and-keyword-best-practices.md)
      + [자산을 기여자로 작업](workfront-dam/workfront-dam-user-contributor/contributor-work-with-assets.md)
...
+ 홈 {#home}
   ...
   + [과(와) 공동 작업 [!UICONTROL 내 업데이트]](workfront-home/collaborate-on-work-with-my-updates.md)
...
+ 우수 사례 {#best-practices}
   ...
   + [타임라인 계획 수립 및 관리](best-practices/timeline-planning-management-bp.md)
...
+ [스크럼 방법론은 무엇이며 어떻게 작동합니까?](agile/what-is-the-scrum-methodology.md)
