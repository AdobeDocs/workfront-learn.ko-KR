...
description: 텍스트 모드, 카멜 대/소문자 및 Workfront의 보고서 보기에서 사용할 수 있는 몇 가지 기본 텍스트 모드에 대해 알아봅니다.
activity: use
...
>[!VIDEO] (https://video.tv.adobe.com/v/3470795/?quality=12&learn=on&enablevpops=0&captions=kor
