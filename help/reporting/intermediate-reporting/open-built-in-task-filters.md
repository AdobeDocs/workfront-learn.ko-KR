...
description: 기본 제공 작업 필터를 검토하여 구축 방법을 확인하고 Workfront에서 고유한 작업 필터를 만드는 방법을 알아봅니다.
activity: use
...
아직 아무도 작업에 동의하지 않은 팀 중 하나에 할당된 작업을 알고 있는지 확인하려고 합니다. &quot;내 팀 중 하나에서 할당 해제된 작업&quot;이라는 작업 보고서를 만듭니다.
...
관심이 있거나 인라인 편집할 수 있는 필드를 포함하도록 열 보기를 설정하십시오. 예를 들어 할당 열을 포함하여 보고서에서 직접 팀원을 작업에 할당할 수 있습니다.
