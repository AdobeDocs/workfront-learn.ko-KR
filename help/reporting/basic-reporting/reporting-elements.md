...
이 비디오에서는 Workfront의 보고 요소(필터, 보기 및 그룹화)를 사용하여 프로젝트, 작업 및 기타 개체에 대한 목록 보고서의 중요한 정보에 액세스하고 정보를 구체화하는 방법을 설명합니다. 필터&#x200B;은 사용자에게 할당된 활성 프로젝트 또는 작업만 표시하는 것과 같이 특정 기준에 따라 목록의 범위를 좁히는 데 도움이 됩니다. 보기&#x200B;은 수익 또는 비용과 같은 특정 필드를 강조 표시하여 열에 표시되는 정보를 결정합니다. 그룹화&#x200B;은 계획된 완료 일자 또는 진행 상태와 같은 기준을 기반으로 목록을 구성합니다.
