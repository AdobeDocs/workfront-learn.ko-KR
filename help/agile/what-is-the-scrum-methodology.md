...
스크럼 방법론은 유연성 모델을 포괄하지만, 제품 소유자, 스컴 기본 등과 같이 팀에 속한 사람들의 역할을 정의하고 작업을 정의하고 완료하는 사례를 정의했다는 점에서 다른 방법론과 다릅니다.
...
백로그를 정리하고 우선 순위를 지정한 후에는 반복을 계획할 차례입니다. (많은 조직에서는 &quot;sprint&quot;와 &quot;iteration&quot;이라는 단어를 상호 교환하여 사용합니다.) 팀은 준비가 된 것으로 간주되는 스토리를 바탕으로 어떤 스토리를 완성할지 결정합니다. 팀은 할당을 지정하고 반복 기간을 결정합니다.
