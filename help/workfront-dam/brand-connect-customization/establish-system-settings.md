...
* **이 포털을 볼 수 있는 사용자**—[!UICONTROL Brand Connect를 볼 수 있는 그룹을 설정합니다]. 예를 들어 [!UICONTROL 로그인됨] 그룹을 추가하면 로그인한 모든 사용자가 포털을 볼 수 있습니다. 단, 폴더 권한은 여전히 적용되므로 사용자가 포털을 볼 수 있어도 [!UICONTROL 로그인됨] 그룹에 폴더에 대한 권한이 부여되지 않는 한 자산에 액세스할 수 없습니다.
* **이 포털에 게시할 수 있는 사용자는 누구입니까?**—자산을 [!UICONTROL Brand Connect]에 게시할 수 있는 그룹을 설정하십시오. 참여자 그룹이 됩니다. 액세스 권한이 있는 항목만 게시할 수 있습니다.
* **브랜드 지침을 관리할 수 있는 사용자는 누구입니까?**—브랜드 지침을 관리할 수 있는 그룹을 설정합니다. 지침 관리는 관리자에게만 제한되지 않습니다. 지침을 편집할 참여자 그룹을 설정할 수 있습니다.
* **검색 엔진에 이 포털을 표시하시겠습니까?**—사람들이 인터넷에서 검색을 실행할 때 [!UICONTROL Brand Connect] URL을 표시하시겠습니까?
* **포함 가능한 링크를 허용하시겠습니까?**—포함 가능한 링크가 [!UICONTROL Brand Connect]에서 제공될 수 있습니까? 자산에 임베드 가능한 링크를 제공하는 [!UICONTROL 공유] 메뉴에 [!UICONTROL 링크 가져오기] 패널이 추가됩니다.
* **Social을 사용/사용하지 않도록 설정하시겠습니까?**—Social이 사용하도록 설정된 경우(확인란 선택), 사용자는 에셋에 대해 좋아하거나 댓글을 달 수 있습니다.
* **다운로드 및 보기 횟수를 활성화/비활성화하시겠습니까?**—활성화되면 사용자는 에셋이 다운로드된 횟수와 에셋에 포함된 댓글을 확인할 수 있습니다.
