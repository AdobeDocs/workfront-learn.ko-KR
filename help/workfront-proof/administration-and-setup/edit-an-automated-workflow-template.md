...
화살표를 클릭해 [!UICONTROL 세부 사항] 섹션을 확장하여 템플릿 이름 또는 템플릿 시간대와 같은 항목을 변경합니다.
...
이 비디오는 [!UICONTROL 워크플로] 영역에서 적용할 수 있는 변경 사항 중 일부를 간략하게 보여 줍니다. 이 비디오 아래의 글머리 기호 목록을 참조하십시오. 이러한 설정을 검토하는 내용입니다. 이 비디오에는 오디오가 없습니다.

>[!VIDEO](https://video.tv.adobe.com/v/335131/?quality=12&learn=on)

다음은 검토 과정에서 [!UICONTROL 워크플로] 섹션에 적용할 수 있는 증명 템플릿 변경 사항입니다.

* [!UICONTROL 단계 이름] 필드 또는 [!UICONTROL 기한] 필드를 클릭하여 해당 정보를 업데이트합니다.
* [!UICONTROL 기한] 옆의 화살표를 선택하여 단계를 잠그거나, 단계가 활성화되는 시기를 결정하거나, 한 번의 결정만 요구합니다.
...
* 수신자를 목록에 추가하는 옵션은 두 가지입니다. [!UICONTROL 단계에 사용자 추가] 창을 연 후 사용자를 추가할 단계를 클릭합니다. 그런 다음 수신자 목록에 이름이나 이메일 주소를 입력하고 증명 역할 및 이메일 경고를 할당합니다. 완료되면 [!UICONTROL 사용자 추가] 버튼을 클릭합니다.
   1. 각 단계 섹션의 오른쪽 상단에서 [!UICONTROL 자세히] 메뉴로 이동하여 [!UICONTROL 단계에 사용자 추가]를 선택합니다.
