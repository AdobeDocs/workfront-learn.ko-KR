...
* 이 비디오는 마케팅 비디오 제작을 위한 템플릿을 생성하고 사용하는 방법에 대한 단계별 안내서를 제공합니다. 먼저 새 템플릿을 처음부터 새로 만들고 이름을 지정한 다음 저장하는 방법을 설명합니다. 이 프로세스에는 &#x200B; 작업을 만들고, 기간 및 전임 작업을 사용하여 타임라인을 설정하고, 개별 사용자가 아닌 작업 역할에 할당하는 세 가지 주요 단계가 포함됩니다. 이 영상&#x200B;은 더 나은 요약과 효율성을 위해 부모-자녀 관계를 이용한 작업 정리를 강조한다. &#x200B;
* 템플릿이 생성되면 이를 활용하여 새로운 프로젝트를 제작할 수 있습니다. 이 비디오에서는 템플릿에서 새 프로젝트를 만들고, 필요한 사항을 조정하고, 필요에 따라 작업을 추가하거나 기간을 수정하는 방법을 보여 줍니다. 또한 &#x200B; 리소스 예약 및 계획 기능을 사용하여 작업에 작업 역할을 할당하는 방법을 보여 줍니다. &#x200B;
* 이 비디오에서는 워크플로의 업데이트 및 개선 사항을 허용하면서 기존 프로젝트를 새 템플릿으로 저장하는 방법을 설명합니다. 혼동을 &#x200B; 방지하고 프로젝트 실행을 간소화하기 위한 템플릿 관리의 중요성을 강조합니다. &#x200B;
...
![메인 메뉴의 블루프린트](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-01.png)
...
![블루프린트 목록](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-02.png)

[!UICONTROL 세부 사항] 화면에는 블루프린트가 설치된 경우 설치 기록을 포함하여 블루프린트에 대한 자세한 내용이 설명됩니다.

![블루프린트 사용에 대한 세부 사항](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-03.png)

블루프린트가 설치된 경우 **[!UICONTROL 세부 사항 보기]**&#x200B;를 클릭하여 만들어진 템플릿과 해당 템플릿을 지원하기 위해 만들어진 기타 오브젝트의 링크를 가져올 수 있습니다.

![블루프린트 설치에 대한 세부 사항](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-04.png)
