...
* **간소화된 할당에 대한 작업 역할:** 작업 역할을 사용하여 프로젝트 템플릿을 통해 작업을 쉽게 할당할 수 있습니다. 작업 역할&#x200B;은 자원 관리 및 능력 계획에 대해 별도로 기록됩니다. &#x200B;
* **Collaboration에 대한 팀 할당:** 팀 아이콘으로 표시되는 팀 이름을 선택하여 팀에 작업을 할당합니다. 팀 구성원&#x200B;이 직접 작업을 할당하거나 팀 리드가 재할당할 수 있으며 보고를 위해 팀 이름을 유지할 수 있습니다. &#x200B;
