...
이 비디오에서는 프로젝트 관리를 위한 재무 성능 지표 및 설정에 대해 설명합니다. 핵심 사항&#x200B;은 다음과 같습니다.

**성과 지표 개요:** 원가 성과 지수, 일정 성과 지수, 원가 일정 성과 지수 및 예상 완료율과 같은 지표는 프로젝트 세부 정보 탭 및 재무 섹션에서 사용할 수 있습니다. 계산&#x200B;에 대한 설명서는 정보 버블 링크를 통해 액세스할 수 있습니다.

**PIM(성과 지표 메서드):** 프로젝트 관리자는 시간 기반(시간 단위 완료) 또는 비용 기반(비용 단위 완료)으로 원가 성과 지표(CPI) 및 완료 시 추정(EAC) 계산 방법을 선택할 수 있습니다. 시스템 관리자&#x200B;은 기본 방법을 전체적으로 설정할 수 있지만, 프로젝트 관리자는 개별 프로젝트에 대해 조정할 수 있습니다. &#x200B;
