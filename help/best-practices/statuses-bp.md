...
계획, 현재, 완료 등과 같은 진행 상위 단계를 나타내도록 프로젝트 상태를 단순하게 유지합니다. 작업, 작업 상태 및 작업 완료율은 프로젝트에서 작업이 전체적으로 어떻게 진행되고 있는지 알려줍니다. 이러한 작업 수준 지표는 프로젝트 완료율, 프로젝트 조건 및 프로젝트 진행 상태로 롤업되며, 이는 모두 프로젝트 상태보다 프로젝트 진행에 대한 더 정확하고 정확한 지표입니다. 또한 이 작업 수준 정보는 더 나은 프로젝트 보고를 제공합니다.
