...
가장 일반적으로 사용되는 메뉴 항목이 눈에 띄는 위치에 있는 메인 메뉴의 옵션(또는 메인 메뉴를 알파벳순으로 구성)
왼쪽 패널 메뉴 섹션(워크플로우를 용이하게 하는 순서로)
필요한 정보를 얻기 위해 작업/문제를 자세히 확인하지 않고도 할당을 완료할 수 있도록 하는 표준 및 사용자 정의 필드가 홈에 표시됨
